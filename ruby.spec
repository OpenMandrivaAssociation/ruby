...
mkdir -p %{buildroot}%{_rpmhome}/macros.d
install -m 644 %{SOURCE4} %{buildroot}%{_rpmhome}/macros.d/macros.ruby
sed -i "s/%%{name}/%{name}/" %{buildroot}%{_rpmhome}/macros.d/macros.ruby
install -m 644 %{SOURCE5} %{buildroot}%{_rpmhome}/macros.d/macros.rubygems
sed -i "s/%%{name}/%{name}/" %{buildroot}%{_rpmhome}/macros.d/macros.rubygems

# Install dependency generators.
mkdir -p %{buildroot}%{_rpmhome}/fileattrs
install -m 644 %{SOURCE8} %{buildroot}%{_rpmhome}/fileattrs
install -m 755 %{SOURCE9} %{buildroot}%{_rpmhome}
install -m 755 %{SOURCE10} %{buildroot}%{_rpmhome}
install -m 755 %{SOURCE11} %{buildroot}%{_rpmhome}
...
%{_rpmhome}/macros.d/macros.rubygems
%{_rpmhome}/fileattrs/rubygems.attr
%{_rpmhome}/rubygems.req
%{_rpmhome}/rubygems.prov
%{_rpmhome}/rubygems.con
